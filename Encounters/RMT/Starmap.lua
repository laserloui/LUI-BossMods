...
local Locales = {
	...
	["label.world_ender3"] = "BURN Ender 3",
	["label.world_ender4"] = "IGNORE Ender 4",
	["label.world_ender5"] = "BURN Ender 5",
...
local ENDER_SPAWN = {
	["W1"] = Vector3.New(-159.57, -95.93, 346.34),
	["W2"] = Vector3.New(-149.60, -96.06, 315.52),
	["W3"] = Vector3.New(-43.89, -95.98, 279.71),
	["W4"] = Vector3.New(-157.29, -95.91, 363.64),
	["W5"] = Vector3.New(-19.37, -95.79, 414.22),
}
...
function Mod:OnUnitCreated(nId, tUnit, sName, bInCombat)
	if sName == self.L["unit.boss"] and bInCombat then
		if not ids[nId] then
			...
			self.core:AddTimer("ASTEROIDS", self.L["label.asteroids"], 26, self.config.timers.rogue_asteroid, Mod.AsteroidsTimer, tAsteroidWave + 1)
