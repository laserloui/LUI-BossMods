...
local Encounter = "Logic_AbstractAugmentationAlgorithm"

local Locales = {
    ["enUS"] = {
        -- Unit names
        ["unit.boss"] = "Abstract Augmentation Algorithm",
    },
    ["deDE"] = {},
    ["frFR"] = {},
}
...
function Mod:new(o)
    ...
    self.displayName = "Abstract Augmentation Algorithm"
    ...
    self.tTrigger = {
        ...
        tNames = {
            ["enUS"] = {"Abstract Augmentation Algorithm"},
        },
    }
    self.run = false
    self.runtime = {}
