...
function Mod:Setup()
	...
	timer("timer_midphase", true, nil, "label.midphase", false, false, 1)
	timer("timer_tomb", true, "af1e90ff", "label.tomb", false, false, 2)
	timer("timer_icestorm", true, nil, "label.icestorm", false, false, 3)
	...
	--[[Adds the defaults for a cast.
		...
		@param sLabel				- Text in Option Panel (Text or Locale Key)
		@param nPriority			- Priority in Option Panel (Top to Bottom)]]
	cast("cast_icestorm", true, nil, "label.icestorm", 1)
	...
	--[[Adds the defaults for a alert.
		...
		@param sLabel				- Text in Option Panel (Text or Locale Key)
		@param nPriority			- Priority in Option Panel (Top to Bottom)]]
	alert("alert_phase2", true, nil, nil, "label.phase2", 1)
	alert("alert_icestorm", true, nil, nil, "label.icestorm", 2)
	alert("alert_twirl", true, nil, nil, "alert.twirlyou", 3)
	...
	--[[Adds the defaults for a sound.
		...
		@param sLabel				- Text in Option Panel (Text or Locale Key)
		@param nPriority			- Priority in Option Panel (Top to Bottom)]]
	sound("sound_phase2", true, "alert", "label.phase2", 1)
	sound("sound_icestorm", true, "run-away", "label.icestorm", 2)
	sound("sound_twirl", true, "inferno", "alert.twirlyou", 3)
	...
	--[[Adds the defaults for a icon/sprite.
		...
		@param sLabel				- Text in Option Panel (Text or Locale Key)
		@param nPriority			- Priority in Option Panel (Top to Bottom)]]
	icon("icon_twirl", true, "target", 40, "ffff0000", "label.twirl", 1)
	...
	--[[Adds the defaults for a aura.
		...
		@param sLabel				- Text in Option Panel (Text or Locale Key)
		@param nPriority			- Priority in Option Panel (Top to Bottom)]]
	aura("aura_twirlyou", true, "target2", "ff00ff00", "alert.twirlyou", 1)
	...
	--[[Adds the defaults for a line.
		...
		@param sLabel				- Text in Option Panel (Text or Locale Key)
		@param nPriority			- Priority in Option Panel (Top to Bottom)]]
	line("line_twirltotomb", true, "ff0f0f0f", 7, "Twirl to Tomb", 1)
	line("line_mycircle", true, "fff0f0f0", 7, "label.mycircle", 2)
	line("line_bossbackline", true, "ff000000", 5, "Line out of Basses back", 3)
end
...
function Mod:RandomMethodName(...)
	...
	--[[Draw Pixie on top of unit or coordinate (Basically a Icon with rotation and offset to the front of a unit.)
		...
		@param fHandler         	- Callback function 													- Optional
		@param tData            	- Data forwarded by callback function									- Optional]]
	self:DrawPixie("icon_twirl", tUnit1, 20, nil, nil, nil, nil, nil, nil, nil, "Unit1_PixieGotRemoved", {MY_AWESOME_PARAMETER}) --the callback will be performed once the pixie would time out.
